...
class Posts(Base):
    ...
    status                  = Column(String(20), nullable=False, default="published") # Yayın durumu: 'published' | 'blocked' | 'review'
    source                  = Column(String(20), nullable=False, default="user") # Post AI'den mi geldi?
    safety_label            = Column(String(50))
    safety_scores           = Column(JSONB)
    generated_from_prompt   = Column(String(500))   # girdiğin açıklama
...
class AIRequests(Base):
    ...
    output_text = Column(String)        # modelin cevabı
